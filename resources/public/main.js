window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9500\/figwheel-connect?fwprocess=3837b5&fwbuild=dev"};
...
document.write('<script>goog.require("scratch.core");</script>');
